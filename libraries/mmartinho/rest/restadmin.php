 ...
 *
 */
abstract class JModelRESTAdmin extends JModelRESTForm {
	/**
	...
	public function getTotal() {
		...
		try {
			...
			$this->cache[$store] = (int) $this->_getListCount();
