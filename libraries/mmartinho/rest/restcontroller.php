...
/**
 * Base class for a Joomla REST Controller
 *
 * Controller (Controllers are where you put all the actual code.) Provides basic
 * functionality, such as rendering views (aka displaying templates).
 *
 */
class JControllerRest extends JObject {
	/**
	...
	public function __construct($config = array()) {
		...
		$xMethods = get_class_methods('JControllerRest');
	 ...
	 *
	 * @return  JControllerRest  A JControllerRest object to support chaining.
	 *
	 */
	 ...
	 * @param   mixed  $path  The directory (string) or list of directories (array) to add.
	 *
	 * @return  JControllerRest  This object to support chaining.
	 *
	 */
