...
echo '<div id="j-main-container" class="span9">'
	...
	.'<h3>'.JText::_($this->t['l'].'_PHOCA_PDF').' - '. JText::_($this->t['l'].'_INFORMATION').'</h3>'
	.'<div style="clear:both;"></div>';

echo '<h3>'.  JText::_($this->t['l'].'_HELP').'</h3>';

echo '<p>'
.'<a href="https://www.phoca.cz/phocapdf/" target="_blank">Phoca PDF Main Site</a><br />'
.'<a href="https://www.phoca.cz/documentation/" target="_blank">Phoca PDF User Manual</a><br />'
.'<a href="https://www.phoca.cz/forum/" target="_blank">Phoca PDF Forum</a><br />'
.'</p>';
...
echo '<div class="btn-group" style="float:left;"><a class="btn btn-large btn-primary" href="https://www.phoca.cz/version/index.php?phocapdf='.  $this->t['version'] .'" target="_blank"><i class="icon-loop icon-white"></i>&nbsp;&nbsp;'.  JText::_($this->t['l'] . '_CHECK_FOR_UPDATE') .'</a></div>';


echo '<div class="btn-group" style="float:left;"><a class="btn btn-large btn-info" href="https://www.phoca.cz/phocapdf-plugins" target="_blank"><i class="icon-share icon-white"></i>&nbsp;&nbsp;'.  JText::_($this->t['l'] . '_CHECK_FOR_AVAILABLE_PLUGINS') .'</a></div>';
