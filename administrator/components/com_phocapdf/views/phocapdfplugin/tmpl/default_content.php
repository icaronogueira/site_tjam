...
echo '<div id="phocapdf-apply"><a href="#" class="btn btn-success" onclick="javascript: submitbutton(\'phocapdfplugin.apply\')"><i class="icon-apply icon-white"></i>&nbsp;&nbsp;'.JText::_('COM_PHOCAPDF_SAVE').'</a></div>';
