...
class JFormFieldSystemCategoryEdit extends JFormFieldCategoryEdit {
	/**
	 * The form field type.
	 *
	 * @var    string
	 */
	public $type = 'SystemCategoryEdit';
	
	/**
	 * @var string
	 */
	protected $systemCategoryParentID = '';
	...
	public function setup(SimpleXMLElement $element, $value, $group = null) {
		...
		if ($return) {
			$category_parent_id = JComponentHelper::getParams('com_unavailability')->get('system_category_parent_id');
			$this->systemCategoryParentID = $category_parent_id ? $category_parent_id : '';
		}
	...
	protected function getOptions() {
		...
		// Filter by system category parent 
		// Differs from the original JFormFieldCategoryEdit::getOptions()
		if($this->systemCategoryParentID) {
			$subQuery->where('parent_id = '.$this->systemCategoryParentID);
		}
