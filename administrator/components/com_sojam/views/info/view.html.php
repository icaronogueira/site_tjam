 ...
 * @author Marcus
 */
class SojamViewInfo extends JViewLegacy {
	...
	protected function prepareSidebar() {		
		SojamHelper::addSubmenu('info'); // activate the submenu (@see SojamHelper)
	...
	protected function addToolbar() {
		...
		JToolbarHelper::title(JText::_('COM_SOJAM_INFO'), '');
		
		if($user->authorise('core.admin', 'com_sojam.component')) {
			JToolbarHelper::preferences('com_sojam');
		}
	}
