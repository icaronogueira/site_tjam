...
<form action="<?php echo JRoute::_('index.php?option=com_sojam&view=info');?>" method="post" name="adminForm" id="adminForm">
	...
	<div id="j-main-container" class="span10">
		...
		<p><?php echo JText::_('COM_SOJAM_COMPONENT_DESC');?></p>
		<h2>Suporte do <?php echo JText::_('COM_SOJAM_COMPONENT_LABEL'); ?></h2>
		<p>
