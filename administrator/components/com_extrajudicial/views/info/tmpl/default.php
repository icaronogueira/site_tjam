...
<form action="<?php echo JRoute::_('index.php?option=com_listing&view=info');?>" method="post" name="adminForm" id="adminForm">
	...
	<div id="j-main-container" class="span10">
		...
		<p>Componente para mostrar informações do sistema de Listagem via REST API.</p>
