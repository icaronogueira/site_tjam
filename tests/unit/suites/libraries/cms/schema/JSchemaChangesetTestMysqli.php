...
/**
 * Test class for JSchemaChangeset covering the MySQLi driver.
 */
class JSchemaChangesetTestMysqli extends TestCaseDatabaseMysqli
{
	/**
	 * Object under test
	 *
	...
	{
		$this->assertAttributeInstanceOf('JDatabaseDriverMysqli', 'db', $this->object, 'The database driver was not correctly injected');
