 ...
 *
 */
class ListingModelPessoaComissao extends JModelRESTList {
	protected $_params=null;
	protected $_cms_id=null;
	 ...
	 * @param array $config
	 */
	public  function __construct($cms_id, $psa_id, $config = array()) {
