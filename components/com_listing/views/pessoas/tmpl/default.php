...
<form action="<?php echo JRoute::_('index.php?option=com_listing&view=pessoas'); ?>" method="post" name="adminForm" id="adminForm">
		...
		<thead>
			<tr>
				...
				<th width="30%" class="">
					<?php 
					echo JHtml::_('grid.sort', 
						'COM_LISTING_FIELD_TITULO_LABEL', 
						'titulo', $listDirn, $listOrder
					); 
					?>
				</th>
					...
					<tr class="row<?php echo $i % 2; ?>" sortable-group-id="1">
						...
						<td class="">
							<a href="<?php echo JRoute::_(
							   'index.php?option=com_listing&view=pessoa&id='.
								(int)$item->id); ?>"
							>
	...
	<input type="hidden" name="titulos" value="<?php echo $this->titulos; ?>" /> 
