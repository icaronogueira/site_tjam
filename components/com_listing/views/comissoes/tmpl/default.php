...
<form action="<?php echo JRoute::_('index.php?option=com_listing&view=comissoes'); ?>" method="post" name="adminForm" id="adminForm">
		...
		<thead>
			<tr>
				...
				<th width="20%" class="nowrap center">
					<?php 
					echo JHtml::_('grid.sort', 
						'COM_LISTING_FIELD_DTHR_INICIO_LABEL', 
						'dthr_inicio', $listDirn, $listOrder
					); 
					?>
				</th>
				<th width="20%" class="nowrap center">
					<?php 
					echo JHtml::_('grid.sort', 
						'COM_LISTING_FIELD_DTHR_FINAL_LABEL', 
						'dthr_final', $listDirn, $listOrder
					); 
					?>
				</th>
					...
					<tr class="row<?php echo $i % 2; ?>" sortable-group-id="1">
						...
						<td class="">
							<a href="<?php echo JRoute::_(
							   'index.php?option=com_listing&view=comissao&id='.
								(int)$item->id); ?>"
							>
						...
						<td class="nowrap center">
							<?php echo $item->dthr_inicio ? MMDateHelper::formataDataBr($item->dthr_inicio) : '-';?>
						</td>
						<td class="nowrap center">
							<?php echo $item->dthr_final ? MMDateHelper::formataDataBr($item->dthr_final) : '-'; ?>
						</td>
						<td class="nowrap center">
