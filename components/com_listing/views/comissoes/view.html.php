 ...
 * @author Marcus
 */
class ListingViewComissoes extends JViewLegacy {
	/**
	 * Category data
	 *
	 * @var  array
	...
	protected function getSortFields() {
		return array(
			...
			'dthr_inicio'=>JText::_('COM_LISTING_FIELD_DTHR_INICIO_LABEL'),
			'dthr_final'=>JText::_('COM_LISTING_FIELD_DTHR_FINAL_LABEL'),
