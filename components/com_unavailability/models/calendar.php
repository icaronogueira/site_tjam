 ...
 *
 */
class UnavailabilityModelCalendar extends JModelList {
	...
	protected function populateState($ordering = null, $direction = null) {
		...
		$start = $app->input->getString('start');
		$this->setState('filter.start', $start);
		
		$end = $app->input->getString('end');
		...
		$this->setState('filter.timezone', $timezone);
	...
	public function getTimeZone() {
		return $this->getState('filter.timezone');
	}
	...
	public function getStartDate() {
		return $this->getState('filter.start');
	}
	...
	public function getEndDate() {
		return $this->getState('filter.end');
	}
	...
	protected function getListQuery() {
		...
		if($start && $end) {
			$query->where(
				'(' .
					'(a.dthr_inicio BETWEEN \''.$start.'\' AND \''.$end.'\') '.
					' OR '.
					'(a.dthr_final BETWEEN \''.$start.'\' AND \''.$end.'\') ' .
				')'
			);
		}
