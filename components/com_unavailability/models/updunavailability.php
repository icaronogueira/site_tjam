 ...
 *
 */
class UnavailabilityModelUpdunavailability extends JModelAdmin {
	 ...
	 * @var    string
	 */
	public $typeAlias = 'com_unavailability.updunavailability';
	...
	public function getForm($data = array(), $loadData = true) {
		...
		$form = $this->loadForm(
			'com_unavailability.updunavailability', 
			'updunavailability',
	...
	protected function loadFormData() {
		$data = JFactory::getApplication()->getUserState(
			'com_unavailability.edit.updunavailability.data', 
			array()
		);
		...
		if(empty($data)) {
			...
			// @see table store for saving the data...
